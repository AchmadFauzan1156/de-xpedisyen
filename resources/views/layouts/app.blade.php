...
<head>
    ...
    {{-- Favicon --}}
    <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='8' fill='%231e3a8a'/><text y='24' x='4' font-size='22' font-family='sans-serif' fill='%23f97316'>D</text></svg>">
